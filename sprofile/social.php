...
<body>
  ...
  <h1 id="title">Social Profile links</h1>

  <form action="social1.php" method="post" id="survey-form">
    ...
    <label id="name-label" class="row-label" for="name">LinkedIn Profile Link:</label>
    <input id="name" class="row-input" type="url" name="linkedin" placeholder="Skip if you don't have one">

    <label id="name-label" class="row-label" for="name">Glassdoor Profile Link:</label>
    <input id="name" class="row-input" type="url" name="glassdoor" placeholder="Skip if you don't have one">
