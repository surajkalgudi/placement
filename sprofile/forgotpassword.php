...
<body>
  ...
  <form action="reset.php" method="post" id="survey-form">
    ...
    <label class="row-label" for="comments">Email ID:</label>
    <input id="name" class="row-input" type="email" name="email" placeholder="Enter your email ID to recover your password" required>
